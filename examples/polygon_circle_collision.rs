...
fn setup_box2d() -> World {
    ...
    let polygon_shape = box2d::shape::shape::Shape::PolygonShape{ points: vec![Vec2::new(-25.0, -50.0), Vec2::new(-75.0, 75.0), Vec2::new(75.0, 75.0), Vec2::new(75.0, -75.0)] };
    ...
    let circle_body_def = BodyDef{shape: circle_shape, body_type: BodyType::DynamicBody, position: Vec2::new(350.0, 100.0), velocity: Vec2::new(0.0, 0.0), restitution: 1.0, mass: 10.0, gravity_scale: 10.0};
